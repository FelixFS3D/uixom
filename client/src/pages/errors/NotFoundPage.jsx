  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-gray-900 via-gray-950 to-black pointer-events-none">
        ...
        <div className="absolute top-20 right-0 w-96 h-96 bg-red-500/20 rounded-full blur-3xl animate-pulse"></div>
      </div>

      <div className="relative z-10 text-center px-4">
        <div className="inline-block mb-8">
          <div className="w-32 h-32 mx-auto bg-gradient-to-br from-red-500/20 to-pink-500/20 rounded-3xl flex items-center justify-center border border-red-500/30 animate-pulse">
            <FileQuestion className="text-red-400" size={64} />
          </div>
        </div>
        <h1 className="text-8xl font-black mb-4">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-pink-400">404</span>
        </h1>
